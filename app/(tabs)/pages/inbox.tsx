...
const Inbox = () => {
  ...
  const accept = async (userid: string, friendid: string, notifid: string, friendUsername: string) => {
              ...
              return (
                <View key={item._id} style={{ backgroundColor: surface, borderRadius: Radius.lg, borderWidth: 1, borderColor: cardBorder, padding: Spacing.md, gap: Spacing.md }}>
                  ...
                  <View style={{ flexDirection: 'row', gap: Spacing.sm }}>
                    <AppButton title="Accept" onPress={() => accept(item.recipient, friend._id, item._id, friend.username)} style={{ flex: 1 }} />
